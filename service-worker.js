    ...
    caches.match(request)
      .then((cached) => {
        ...
        return fetch(request)
          ...
          .catch(() => {
            // Corrigido: request.headers.get('accept') pode retornar null
            // (ex.: requisições sem header 'accept'), o que quebrava o SW
            // com "Cannot read properties of null (reading 'includes')".
